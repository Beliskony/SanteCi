...
// PATCH /api/appointments/[id]/start — démarre la consultation (médecin)
export async function PATCH(
  ...
  try {
    ...
    const appointment = await appointmentService.startConsultation(params.id, String(authDoctor._id));
